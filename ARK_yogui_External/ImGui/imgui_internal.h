...
struct ImGuiContext
{
    ...
    ImGuiContext(ImFontAtlas* shared_font_atlas) : BackgroundDrawList(NULL), ForegroundDrawList(NULL)
    {
        ...
        BackgroundDrawList._OwnerName = XorString("##Background"); // Give it a name for debugging
        ForegroundDrawList._Data = &DrawListSharedData;
        ForegroundDrawList._OwnerName = XorString("##Foreground"); // Give it a name for debugging
