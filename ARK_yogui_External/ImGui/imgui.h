...
#define IMGUI_VERSION               XorString("1.70 WIP")
...
struct ImVec2
{
	...
	/*ImVec2 operator-(const ImVec2 & oVec)
	{
		return ImVec2(x - oVec.x, y - oVec.y);
	}
	ImVec2 operator/(const float Val)
	{
		return ImVec2(x / Val, y / Val);
	}
	ImVec2& operator+=(const ImVec2 s) 
	{
		x += s.x;
		y += s.y;
		return *this;
...
namespace ImGui
{
	...
	IMGUI_API bool          CostomSliderFloat(ImFont* pFont, const char* label, float* v, float v_min, float v_max, const char* format = "%.3f", float power = 1.0f);
	...
	IMGUI_API bool			CustomSliderInt(ImFont * pFont, const char * label, int * v, int v_min, int v_max, const char* format = "%d");

    IMGUI_API bool          SliderInt2(const char* label, int v[2], int v_min, int v_max, const char* format = "%d");
    IMGUI_API bool          SliderInt3(const char* label, int v[3], int v_min, int v_max, const char* format = "%d");
    IMGUI_API bool          SliderInt4(const char* label, int v[4], int v_min, int v_max, const char* format = "%d");
    IMGUI_API bool          SliderScalar(const char* label, ImGuiDataType data_type, void* v, const void* v_min, const void* v_max, const char* format = NULL, float power = 1.0f);
	IMGUI_API bool          CostomSliderScalar(ImFont * pVarFont, const char* label, ImGuiDataType data_type, void* v, const void* v_min, const void* v_max, const char* format = NULL, float power = 1.0f);
...
struct ImGuiTextFilter
{
    ...
    IMGUI_API bool      Draw(const char* label = XorString("Filter (inc,-exc)"), float width = 0.0f);  // Helper calling InputText+Build
